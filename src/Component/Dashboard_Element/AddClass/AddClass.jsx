              ...
              <form action="" onSubmit={ handleClass }>
                ...
                <div className="flex justify-between gap-6 mb-10">
                    <div className="lg:w-[50%] w-full">
                        ...
                        <input type="text" name="Instructor_name" className="block w-full outline-none h-[50px] border-[2px] rounded-md px-4" placeholder="Instructor Name" required />
                    </div>
                    <div className="lg:w-[50%] w-full">
                        <label className="text-[20px] mb-3 block font-semibold text-[#141414]">Instructor Email</label>
                        <input type="email" name="email" className="block w-full outline-none h-[50px] border-[2px] rounded-md px-4" placeholder="Instructor Email" required />
                    </div>
                </div>
